package com.bluetooth.teacher.ui;
...
import com.bluetooth.teacher.R;
import com.bluetooth.communicator.Message;

import java.util.ArrayList;

/*
 * Этот класс представляет адаптер для отображения сообщений о подключении в RecyclerView.
 * Семантика стандартна. Просто описывает поведение элемента\ов RecyclerView списка.
 */
